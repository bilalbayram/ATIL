...
@objc protocol ATILHelperProtocol {
    ...
    /// Remove a launchd job from the active domain immediately.
    ...
    func enableLaunchdJob(label: String, domain: String, plistPath: String, withReply reply: @escaping (Bool, String?) -> Void)
